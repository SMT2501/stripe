package com.example.paywithstripe;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // Get your key here: https://stripe.com/docs/keys#obtain-api-keys
                        ...
                        httpClient.newCall(request)
                                .enqueue(new Callback() {
                                    ...
                                    public void onFailure(@NotNull Call call, @NotNull IOException e) {
                                        weakActivity.get().displayAlert("Failed to decode response from server", e.getLocalizedMessage(),
                                                false);
                                    }
                                    ...
                                    public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                                        if (!response.isSuccessful()) {
                                            weakActivity.get().displayAlert("Failed to decode response from server",
